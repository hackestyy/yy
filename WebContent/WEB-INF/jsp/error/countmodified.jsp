...
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="91%" bgcolor="#80adda" class="white"  >已经成功修改您的帐号，请重新登录！</td>
  </tr>
      ...
      <table width="100%" height="178" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="178" valign="top" bgcolor="#FFFFFF">
			...
			<input type="button" class="button" value="返回请按这里" onclick="location.href='logout.do'" style="cursor: hand;" >
                </td>
              </tr>
            </table>
          </td>
