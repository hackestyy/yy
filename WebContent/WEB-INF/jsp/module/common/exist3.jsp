...
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="91%" bgcolor="#80adda" class="white"  >您已经在本学会中注册过了，不需要再次进行注册！谢谢！</td>
  </tr>
      ...
      <table width="100%" height="178" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="178" valign="top" bgcolor="#FFFFFF">
			...
			<input type="button" class="button" value="返回请按这里！" onclick="location.href='academyadminsmemberbaseinforeturnlist.do'" style="cursor: hand;" >
                </td>
              </tr>
            </table>
          </td>
