...
<tr><td valign="middle">
	...
	<tr>
		<td width=30></td>
		<td width=110 align=center valign="top"><img src="images/succeed.gif"></td>
		<td width=10></td>
		<td valign="top">
			<table cellspacing='0' cellpadding='0' border='0'>
			<tr height=25 bgcolor="f4f4f4"><td colspan="2">&nbsp;&nbsp;<b><bean:message key="result.title"/>!</b></td></tr>
			<tr height=10 colspan=2><td></td></tr>
			</td></tr>
			<tr height=7 colspan=2><td></td></tr>
			<tr><td colspan=2 align=right>
                          <html:button property="isee" styleClass="button"  onclick="history.back();"><bean:message key="db.confirm"/></html:button>
			&nbsp;&nbsp;
			</td></tr>
			</table>
		</td>
