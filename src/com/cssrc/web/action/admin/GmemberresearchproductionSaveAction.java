...
public class GmemberresearchproductionSaveAction extends Action {
	public GmemberresearchproductionSaveAction() {
	}
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
		...
		if (!gmemberresearchproductionDAO.saveGmemberresearchproduction(bean)) {
