...
public class SmemberacademicliteratureSaveAction extends Action {
	public SmemberacademicliteratureSaveAction() {
	}
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
		...
		if (!smemberacademicliteratureDAO.saveSmemberacademicliterature(bean)) {
			return actionMapping.findForward("smiderrorAdd");
		}
		httpServletRequest.getSession().setAttribute("smal_id", bean.getSmal_id());
