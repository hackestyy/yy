...
public class AcademybaseinfocouncilUpdateAction extends Action {
	public AcademybaseinfocouncilUpdateAction() {
	}
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
		...
		bean.setRegisterdate(DateUtil.getCalendar(tempstartdate));
		form.setStartdate(DateUtil.getCalendar(form.getTempstartdate()));
