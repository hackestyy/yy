...
public class ShadeputyacademicliteratureUpdateAction extends Action {
	public ShadeputyacademicliteratureUpdateAction() {
	}
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
		...
		if (shadeputyacademicliteratureDAO.modifyShadeputyacademicliterature(bean)) {
