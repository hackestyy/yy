...
public class SearchJCDBWYListDownlAction extends Action {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
		...
		String searchsql = (String) httpServletRequest.getSession().getAttribute("searchJCdbwysql");
		String title = "第" + (String) httpServletRequest.getSession().getAttribute("assoduty_s") + "届科协代表委员列表";
