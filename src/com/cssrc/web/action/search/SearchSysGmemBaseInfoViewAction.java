...
public class SearchSysGmemBaseInfoViewAction extends Action {

	public SearchSysGmemBaseInfoViewAction() {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
		try {
			...
			bean = gmemberbaseinfoDAO.getGmemberbaseinfo(relationbean.getGmbi_id());
